...
.points {
    background-image: url("/resources/assets/points.svg");
...
.bottom-line-1 {
    background-image: url("/resources/assets/Subtract.svg");
    background-repeat: no-repeat;
    background-size: cover;
}

.bottom-line-2 {
    background-image: url("/resources/assets/Subtract(1).svg");
    background-repeat: no-repeat;
    background-size: cover;
}
