        ...
        <div class="sm:flex justify-around w-full ">
            <div>
                ...
                <div v-if=" video  && video.length>0">
                    <button  type="button" @click="removeVideo()"  class="rounded-full hover:bg-white hover:bg-opacity-25 p-2 focus:outline-none text-white transition duration-200"><svg class="ml-auto" width="23" height="23" viewBox="0 0 23 23" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <video class="max-w-[600px] mb-20 max-h-[400px] h-auto" controls="controls"  :src="video" alt="fileName"  >
                    </video>
                </div>
                <div  v-if=" preview && preview.length>0">
                    <button type="button" @click="removeImg" class="rounded-full hover:bg-white hover:bg-opacity-25 p-2 focus:outline-none text-white transition duration-200">
                        <svg class="ml-auto" width="23" height="23" viewBox="0 0 23 23" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <rect width="28.9691" height="3.10383" rx="1.55192" transform="matrix(0.707129 0.707085 -0.707129 0.707085 2.51465 0.321777)" fill="#D9D9D9"/>
                            <rect width="28.9691" height="3.10383" rx="1.55192" transform="matrix(0.707129 -0.707085 0.707129 0.707085 0 20.4838)" fill="#D9D9D9"/>
                        </svg>
                    </button>
